...
description: 'Analizar recursos de Azure usados en la aplicacion (archivos IaC y/o recursos en un rg objetivo) y optimizar costes, creando GitHub issues para las optimizaciones identificadas.'
---

# Azure Cost Optimize

Este flujo analiza archivos Infrastructure-as-Code (IaC) y recursos de Azure para generar recomendaciones de optimizacion de costes. Crea issues individuales de GitHub para cada oportunidad de optimizacion y un issue EPIC para coordinar la implementacion, facilitando el seguimiento y la ejecucion de iniciativas de ahorro.
