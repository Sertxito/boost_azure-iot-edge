...
description: Analiza grupos de recursos de Azure y genera diagramas de arquitectura Mermaid detallados mostrando las relaciones entre recursos individuales. Usa esta habilidad cuando el usuario pida un diagrama de sus recursos de Azure o ayuda para entender como se relacionan.
...
Un usuario puede pedir ayuda para entender como encajan los recursos entre si, o para crear un diagrama que muestre sus relaciones. Tu mision es examinar grupos de recursos de Azure, entender su estructura y relaciones, y generar diagramas Mermaid completos que ilustren claramente la arquitectura.
...
4. **Generacion de diagramas**: crear diagramas Mermaid detallados y precisos
5. **Creacion de documentacion**: producir archivos markdown claros con diagramas embebidos

## Proceso de trabajo

### Paso 1: Seleccion de Resource Group
...
### Paso 2: Descubrimiento y analisis de recursos
...
### Paso 3: Construccion del diagrama
